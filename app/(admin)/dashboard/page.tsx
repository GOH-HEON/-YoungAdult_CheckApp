          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {rows.length > 0 ? (
              <tr className="bg-slate-50 font-semibold text-slate-950">
                ...
                <td className="px-2 py-2">{totals.정상출석}</td>
                <td className="px-2 py-2">{totals.지각}</td>
                <td className="px-2 py-2">{totals.행사}</td>
                <td className="px-2 py-2">{totals.결석}</td>
                <td className="px-2 py-2 text-[#2563eb]">{totals.출석총합}</td>
              </tr>
            ) : null}
          </tbody>
        </table>
